...
function hRoot(){
	$url = $_SERVER['DOCUMENT_ROOT'].ROOTNO;
	return $url;
}
...
$comn="Delta state Smart Education DELSU";
$CA2="Pratical";
...
$dated = date('Y-m-d', strtotime('-2 days', strtotime(date("Y-m-d"))));
...
//$del_ucomfirmed01 = mysqli_query($condb,"DELETE FROM fshop_tb WHERE fpay_status = '0' and  dategen <=  DATE_SUB(NOW(), INTERVAL 2 DAY)");
